...
typedef struct {
    ...
    uint8_t arm_button_toggle_mask;
    uint8_t arm_button_event_mask;
    uint8_t arm_button_pressed_mask;
    uint8_t arm_button_raw_mask;
    uint8_t remote_key0;
    uint8_t remote_key1;
    uint8_t remote_key2;
    uint8_t remote_key3;
    uint8_t remote_key_mask;
    uint8_t arm_place_raise_active;
    uint8_t kfs_mode;
    uint16_t kfs_height_mm;
    uint8_t delivery_origin_switch;
    uint8_t yaw_toggle_latched;
    uint8_t delivery_trigger_latched;
    uint8_t j1_return_from_delivery_slow;
    uint32_t delivery_elapsed_ms;
    float j1_preset_deg;
    float j1_trim_deg;
    float j1_preset_target_deg;
    float j1_slow_move_cmd_deg;
