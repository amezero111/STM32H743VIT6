...
// 四轮实际方位: 左前 ID3, 右前 ID4, 左后 ID1, 右后 ID2
#define STEERING_CHASSIS_ALIGN_ECD_LF   8107 // ID3 左前
#define STEERING_CHASSIS_ALIGN_ECD_RF   5664 // ID4 右前
#define STEERING_CHASSIS_ALIGN_ECD_LB   4381 // ID1 左后
#define STEERING_CHASSIS_ALIGN_ECD_RB   3180 // ID2 右后

#define STEERING_CHASSIS_ALIGN_ANGLE_LF STEERING_CHASSIS_ALIGN_ECD_LF / 8192.f * 360.f
#define STEERING_CHASSIS_ALIGN_ANGLE_RF STEERING_CHASSIS_ALIGN_ECD_RF / 8192.f * 360.f
#define STEERING_CHASSIS_ALIGN_ANGLE_LB STEERING_CHASSIS_ALIGN_ECD_LB / 8192.f * 360.f
#define STEERING_CHASSIS_ALIGN_ANGLE_RB STEERING_CHASSIS_ALIGN_ECD_RB / 8192.f * 360.f

// ================== 三舵轮底盘定义 (根据实际硬件值) ==================
// 假设：1号为左后，2号为右后，3号为正前方
#define STEERING_CHASSIS_ALIGN_ECD_1   6800 // 舵轮1号垂直机械零值700
#define STEERING_CHASSIS_ALIGN_ECD_2   8142 // 舵轮2号垂直机械零值8011
#define STEERING_CHASSIS_ALIGN_ECD_3   150 // 舵轮3号垂直机械零值1240
